...
plt.figure(f'{stock_id} Rate-Length-Point')
plt.subplot(221)
plt.plot(up_rate_p.p, color='red')
plt.plot(down_rate_p.p, color='blue')

plt.subplot(222)
plt.plot(up_len_p.p, color='red')
plt.plot(down_len_p.p, color='blue')
